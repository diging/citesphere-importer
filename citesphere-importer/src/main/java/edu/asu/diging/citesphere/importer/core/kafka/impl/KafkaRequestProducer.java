...
import edu.asu.diging.citesphere.importer.config.CitesphereImporterKafkaConfig;
...
import edu.asu.diging.citesphere.importer.core.kafka.IKafkaRequestProducer;
...
public class KafkaRequestProducer implements IKafkaRequestProducer {
    ...
    @Autowired
    private CitesphereImporterKafkaConfig kafkaConfig;
     ...
     */
    @Override
    public void sendRequest(KafkaImportReturnMessage msg, String topic) throws MessageCreationException {
