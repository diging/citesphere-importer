...
import edu.asu.diging.citesphere.importer.core.kafka.impl.ReferenceImportListener;

@Configuration
@EnableKafka
@PropertySource("classpath:/config.properties")
public class CitesphereImporterKafkaConfig {
    ...
    @Bean
    public ReferenceImportListener referenceImportListener() {
        return new ReferenceImportListener();
    }
